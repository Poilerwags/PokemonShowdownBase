export const AbilitiesText: {[k: string]: AbilityText} = {
	...
	chlorofury: {
		name: "Chlorofury",
		desc: "On switch-in, this Pokemon's Attack and Special Attack are raised by 1 stage.",
		shortDesc: "On switch-in, Atk and Sp. Atk are raised 1 stage.",
	},
	chlorophyll: {
		name: "Chlorophyll",
	...
	firedup: {
		name: "Fired Up",
		desc: "Before this Pokemon uses a Fire-type attack its Attack, Special Attack, and Speed are all increased by 1 stage each.",
		shortDesc: "Raises Attack, Sp. Atk and Speed by 1 stage before using a Fire-type attack.",
	},
	flamebody: {
		name: "Flame Body",
	...
	foundry: {
		...
		shortDesc: "Users Rock-type moves become Fire type and have 1.3x power. For Rocks see Stealth Coal.",
	},
	friendguard: {
		name: "Friend Guard",
	...
	lernean: {
		name: "Lernean",
		desc: "User's attacks do less damage but hit multiple times, 5 times plus 1 time for every 20% health lost.",
		shortDesc: "This Pokemon does less damage but hits multiple times depending on HP left, see wiki.",
	},
	levitate: {
		name: "Levitate",
	...
	proteanmaxima: {
		name: "Protean Maxima",
		shortDesc: "This Pokemon's type, stats and ability change to match one of the eeveelutions.",
	},
	psychicsurge: {
		name: "Psychic Surge",
	...
	sleet: {
		name: "Sleet",
		shortDesc: "Summons Sleet, damages non Ice-types by 1/8 max HP every turn. Dissapears on retreat.",
	},
	slowstart: {
		name: "Slow Start",
